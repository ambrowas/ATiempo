...
def generate_mock_employee_payroll():
    ...
    for employee_doc in all_employees:
        ...
        for month_num in range(1, 7):
            ...
            # IMPORTANT CHANGE HERE: Changed from /generate-payroll-pdf-mock to /generate-payroll-pdf
            payroll_url = (
                f"http://localhost:5001/generate-payroll-pdf?" # <--- CORRECTED ENDPOINT
...
if __name__ == "__main__":
    ...
    SERVICE_ACCOUNT_KEY_PATH = "/Users/eleela/Documents/ATIEMPO-Final/atiempo-9f08a-firebase-adminsdk-fbsvc-e5a274b0b2 copy.json"
